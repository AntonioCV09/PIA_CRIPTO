...
class DesencriptacionMetodoVigenereScreen extends StatefulWidget {
  const DesencriptacionMetodoVigenereScreen({super.key});

  @override
  _DesencriptacionVigenereScreenState createState() => _DesencriptacionVigenereScreenState();
}

class _DesencriptacionVigenereScreenState extends State<DesencriptacionMetodoVigenereScreen> {
